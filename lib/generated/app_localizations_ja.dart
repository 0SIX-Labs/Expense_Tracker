...
class AppLocalizationsJa extends AppLocalizations {
  ...
  @override
  String get selectYourCurrency => '通貨を選択してください';

  @override
  String get billingCycleStart => '請求サイクル開始';

  @override
  String get billingCycleDescription => '支出追跡サイクルは毎月この日にリセットされます';

  @override
  String get day => '日';

  @override
  String get nativeMobileApp => 'ネイティブモバイルアプリ';

  @override
  String get fullyPrivate => '100%プライベート';

  @override
  String get allDataStaysOnDevice => 'すべてのデータはデバイスに残ります';

  @override
  String get noBackend => 'バックエンドなし';

  @override
  String get noServerNoAccount => 'サーバー不要、アカウント不要';

  @override
  String get fullyOffline => '完全オフライン';

  @override
  String get worksWithoutInternet => 'インターネットなしで動作';

  @override
  String get lightningFast => '超高速';

  @override
  String get instantAccessNoLoading => '即座にアクセス、読み込み不要';

  @override
  String get pleaseEnterYourNameToContinue => '続行するにはお名前を入力してください';

  @override
  String get welcomeToFynzDescription => '100%オフラインで動作するパーソナル支出トラッカー';

  @override
  String get personalizeExperienceDescription => 'お名前から始めましょう';
}
