...
class AppLocalizationsRu extends AppLocalizations {
  ...
  @override
  String get appTitle =>
      'Fynz - Приложение для отслеживания бюджета и расходов';
  ...
  String get monthStartDescription =>
      'Выберите день, когда начинается ваш цикл выставления счетов, чтобы точно отслеживать расходы';
  ...
  String get monthlyIncomeDescription =>
      'Введите источники дохода, чтобы эффективно планировать бюджет';
  ...
  String get allSetDescription =>
      'Ваш профиль готов. Начнем отслеживать ваши расходы';
  ...
  String get categoriesDescription =>
      'Создавайте и управляйте пользовательскими категориями расходов и доходов';
  ...
  String get thisCurrencyWillBeUsed =>
      'Эта валюта будет использоваться во всем приложении для всех транзакций';
  ...
  @override
  String get chooseLanguage => 'Выберите предпочитаемый язык';

  @override
  String get selectYourCurrency => 'Выберите вашу валюту';

  @override
  String get billingCycleStart => 'Начало цикла выставления счетов';

  @override
  String get billingCycleDescription =>
      'Ваш цикл отслеживания расходов сбрасывается в этот день каждого месяца';

  @override
  String get day => 'День';

  @override
  String get nativeMobileApp => 'Нативное мобильное приложение';

  @override
  String get fullyPrivate => '100% Конфиденциально';

  @override
  String get allDataStaysOnDevice => 'Все данные остаются на вашем устройстве';

  @override
  String get noBackend => 'Без бэкенда';

  @override
  String get noServerNoAccount => 'Без сервера, без аккаунта';
  ...
  @override
  String get lightningFast => 'Молниеносно быстро';

  @override
  String get instantAccessNoLoading => 'Мгновенный доступ, без загрузки';

  @override
  String get pleaseEnterYourNameToContinue =>
      'Пожалуйста, введите ваше имя для продолжения';

  @override
  String get welcomeToFynzDescription =>
      'Ваш персональный трекер расходов, работающий 100% офлайн';

  @override
  String get personalizeExperienceDescription => 'Начнем с вашего имени';
}
